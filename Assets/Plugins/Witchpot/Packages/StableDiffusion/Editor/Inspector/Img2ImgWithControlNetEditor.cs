...
{
    [CustomEditor(typeof(Img2ImgWithControlNet))]
    public class Img2ImgWithControlNetEditor : StableDiffusionClientEditor
    {
        public override void OnInspectorGUI()
        {
            base.OnInspectorGUI();

            Img2ImgWithControlNet component = (Img2ImgWithControlNet)target;
